...
excerpt: 'TL;DR: This paper defines and analyzes the common phenomenon of "visual dominance" in composed image retrieval tasks, where retrieval results are dominated by reference images and overlook the modification text. To mitigate this "visual dominance", we propose a Fashion Enhance-and-Refine Network (FashionERN) that enhances text semantics and filters visual semantics.'
date: 2024-02-17
venue: 'AAAI'
...
<img src="../images/FashionERN.pdf" alt="FashionERN" width="100" style="vertical-align: middle;"/> 
